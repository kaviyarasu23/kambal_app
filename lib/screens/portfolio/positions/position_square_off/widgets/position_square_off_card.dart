...
class ExitAllPositionsCard extends ConsumerWidget {
  final PositionBookInfoResult data;
  const ExitAllPositionsCard({
    Key? key,
    required this.data,
  }) : super(key: key);
        ...
        builder: (_, AsyncSnapshot<TouchlineUpdateStream> snapshot) {
          ...
          return Container(
            decoration: BoxDecoration(
                border: Border(
                    left: BorderSide(
              color: data.isSelected! ? colors.kColorBlue : colors.kColorWhite,
              width: 10.0,
            ))),
            child: Padding(
                                  ...
                                  child: Center(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        "BO",
                                        style:
                                            textStyles.kTextEightW400.copyWith(
                                          color: data.netQty == "0"
                                              ? colors.kColorGreyFade
                                              : colors.kColorIntradayButton,
                                        ),
