...
class UnblockUserOTPScreen extends ConsumerStatefulWidget {
  const UnblockUserOTPScreen({super.key});

  @override
  ConsumerState<UnblockUserOTPScreen> createState() =>
      _UnblockUserOTPScreenState();
}

class _UnblockUserOTPScreenState extends ConsumerState<UnblockUserOTPScreen> {
  ...
  void resendCode() {
    setState(() {
      ...
      ref
          .read(loginProvider)
          .submitUnblockUser(context: context, isResend: true);
    });
  }
                    ...
                    CustomTextFormField(
                      ...
                      sumitField: (value) {
                        if (value.length == 6) {
                          ref
                              .read(loginProvider)
                              .submitUnblockUserVerifyOTP(context);
                        }
                      },
                      onChanged: (value) {
