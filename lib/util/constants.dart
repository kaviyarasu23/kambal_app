...
const String trailingStoplossNull = "Trailing Stoploss cannot be Empty";
...
const String trigPrc = "Trigger Price can not be greater than price. ";
const String PrcTrig = "Price can not be greater than trigger price ";
const String trigPrcCOLtp = "Trigger Price should be less than Price and LTP";
const String trigHLtp = "Trigger Price should be greater than";
const String trigCOHLtp = "Trigger Price should be greater than Price and LTP";
const String trigLLtp = "Trigger Price should be less than";
...
const String trailingStoplossZero =
    "Trailing Stoploss should be greater than 0.";
